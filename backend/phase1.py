...
class Phase1():
    ...
    def phase1(self) -> Dict:
        self.map.clauses_connues.append(self.map.var_rien((self.state['position'][0],self.state['position'][1])))
        it=0
        phase1 = []
        ...
        while(it < 2 * nb_cases):
            ...
            position = "position : (" + str(self.state['position'][0]) + " , " + str(self.state['position'][1]) + ")"
